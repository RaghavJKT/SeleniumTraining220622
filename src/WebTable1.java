...
public class WebTable1 {
	...
	public static void main(String[] args) {
		 ...
		 * ".\\Drivers\\chromedriver.exe"); WebDriver driver = new ChromeDriver();
		 * driver.manage().window().maximize();
		 * driver.get("https://demo.guru99.com/test/web-table-element.php"); List <
		 * WebElement > rows_table = driver.findElements(By.tagName("tr")); //To
		 * calculate no of rows In table. int rows_count = rows_table.size(); //Loop
		 * will execute till the last row of table. for (int row = 0; row < rows_count;
		 * row++) { //To locate columns(cells) of that specific row. List < WebElement >
